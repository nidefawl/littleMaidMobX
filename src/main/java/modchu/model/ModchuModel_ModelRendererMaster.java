...
//@-@b173
	...
	public void render(float par1, boolean b) {
		boolean hide = !base.showModel || base.isHidden;
		if (base.boxName!=null&&base.boxName.toLowerCase().contains("skirt")) {
//			System.out.println("render skirt "+boxName+" "+base.baseModel+ " - "+hide);
//			if (!hide) {
//				System.out.println("render skirt rotationPointX "+base.rotationPointX);
//				System.out.println("render skirt rotationPointY "+base.rotationPointY);
//				System.out.println("render skirt rotationPointZ "+base.rotationPointZ);
//				System.out.println("render skirt offsetX "+base.offsetX);
//				System.out.println("render skirt offsetY "+base.offsetY);
//				System.out.println("render skirt offsetZ "+base.offsetZ);
//			}
		}
