...
*/
		...
		case caps_WorldTotalTime:
			return owner != null ? owner.worldObj.getWorldInfo().getWorldTotalTime() : Minecraft.getMinecraft().theWorld.getWorldInfo().getWorldTotalTime();
		case caps_WorldTime:
			return owner != null ? owner.worldObj.getWorldInfo().getWorldTime() : Minecraft.getMinecraft().theWorld.getWorldInfo().getWorldTime();
		case caps_MoonPhase:
			return owner != null ? owner.worldObj.getMoonPhase() : Minecraft.getMinecraft().theWorld.getMoonPhase();
