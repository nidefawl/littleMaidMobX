...
public class Modchu_ASAlmighty extends Modchu_ASBase {
	...
	protected Object minecraftGetMinecraft() {
		...
		if (o == null) {
			String s = "Modchu_Main-getMinecraft o == null !! loadClass(Minecraft)="+Modchu_Reflect.loadClass("Minecraft")+" isForge="+LittleMaidMobX.isForge+" getMinecraftVersion()="+Modchu_Main.getMinecraftVersion();
...
*/
	...
	protected Object modelRightArm(Object model) {
		if (model instanceof net.minecraft.client.model.ModelBase) {
