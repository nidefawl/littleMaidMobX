...
public class EntitySelect extends EntityLiving implements IModelCaps, ITextureEntity {
...
//			{ null, null , null , null }
//	};
	protected EntityCapsBase entityCaps;
	public TextureData textureData;


	public EntitySelect(World par1World) {
		super(par1World);
		entityCaps = new EntityCapsBase(this);
		textureData = new TextureData(this, entityCaps);
	}
