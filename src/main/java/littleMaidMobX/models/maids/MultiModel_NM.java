...
//		Object entityliving = entityCaps.getCapsValue(IModelCaps.caps_Entity);
//		if (entityliving != null); else return;
//		int ticksExisted = _AS.getInt(_AS.entityTicksExisted, entityliving);
...
//			if (isWorkingDelay) {
////-@-125
//				int maidMode = (Integer) _Reflect.getFieldObject("EntityLittleMaid", "getMaidModeInt", entityliving);
//				int i = 0x0080;
//				int i1 = 0x0021;
//				int i2 = 0x0083;
////@-@125
///*//125delete
//				int maidMode = (Integer)_Reflect.getFieldObject(LMM_EntityLittleMaid, "getMaidMode", entityliving);
//				int i = 4;
//				int i1 = 6;
//				int i2 = 8;
//*///125delete
...
//	}////	@Override
//	public void defaultPartsSettingAfter(IModelCaps entityCaps) {
//		int i = ModelCapsHelper.getCapsValueInt(this, entityCaps, caps_armorType);
