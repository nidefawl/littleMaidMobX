...
public abstract class MultiModelOkotaSR2 extends ModelLittleMaid_SR2 {
	...
	protected void eyeRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, IModelCaps entityCaps) {
		...
		if (Modchu_EntityCapsHelper.getCapsValueBoolean(this, entityCaps, caps_aimedBow)) {
			if (eyeFlag) {
				//Not sure which method is used now
				setCapsValue(entityCaps, caps_isInvisible, eyeL, true);
