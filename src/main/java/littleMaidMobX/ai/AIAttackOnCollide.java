...
public class AIAttackOnCollide extends EntityAIBase implements IEntityAI {
	...
	public AIAttackOnCollide(EntityLittleMaid par1EntityLittleMaid, float par2, boolean par3) {
